#===============================================================================
# Description: Prepares regional averages of GCM
#===============================================================================
...
#===============================================================================
# 3). load the projections data tasmax
#===============================================================================
...
namefile = paste0(dir$data,'gcms/list_gcms_future_tasmax.mat');
...
#===============================================================================
# 3). load the projections data pr
#===============================================================================
...
listGCMs[1]
# extract lat lon and mask
filename=paste0(dir$gcm, 'gcm_1_x_1/pr/', listGCMs[1])
gcm.nc <- nc_open(filename)
gcm.nc$dim$lon$vals -> lon
gcm.nc$dim$lat$vals -> lat
ni = length(lon)
...
for (ifile in 1:length(listGCMs)) {
  ...
  # "tasmax_CMIP6Amon_ACCESS-CM2_historical_r1i1p1f1_mon_1950-2014_CA_Yizhou.nc"
  # tasmax_CMIP6Amon_UKESM1-0-LL_ssp585_r8i1p1f2_mon_2015-2100_CA_Yizhou.nc
  namefile_hist = paste0(dir$gcm, 'gcm_1_x_1/pr/', listGCMs[ifile])
  aux = gsub('1950-2014', '2015-2100', listGCMs[ifile])
  namefile_ssp245 = paste0(dir$gcm,
                           'gcm_1_x_1/pr/',
                           gsub('historical', 'ssp245', aux))
...
namefile = paste0(dir$data,'gcms/list_gcms_future_pr.mat');
writeMat(namefile, model_name  = model_name)

namefile = paste0(dir$data,'gcms/pr-historical-1950-2014-monthly.mat');
writeMat(namefile, historical = historical)

namefile = paste0(dir$data,'gcms/pr-ssp245-2015-2100-monthly.mat');
writeMat(namefile, ssp245 = ssp245)

namefile = paste0(dir$data,'gcms/pr-ssp585-2015-2100-monthly.mat');
writeMat(namefile, ssp585 = ssp585)
